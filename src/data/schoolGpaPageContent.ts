  ...
  },
{
    ...
    schoolName: 'Alabama GPA Calculator',
    shortName: 'Alabama',
    location: 'Alabama',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Alabama',
    externalLinks: [
      { label: 'Alabama Higher Education Authority', url: 'https://www.ache.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Alaska GPA Calculator',
    shortName: 'Alaska',
    location: 'Alaska',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Alaska',
    externalLinks: [
      { label: 'Alaska Higher Education Authority', url: 'https://www.alaska.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Arizona GPA Calculator',
    shortName: 'Arizona',
    location: 'Arizona',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Arizona',
    externalLinks: [
      { label: 'Arizona Higher Education Authority', url: 'https://www.azregents.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Arkansas GPA Calculator',
    shortName: 'Arkansas',
    location: 'Arkansas',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Arkansas',
    externalLinks: [
      { label: 'Arkansas Higher Education Authority', url: 'https://adhe.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'California GPA Calculator',
    shortName: 'California',
    location: 'California',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in California',
    externalLinks: [
      { label: 'California Higher Education Authority', url: 'https://www.csac.ca.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Colorado GPA Calculator',
    shortName: 'Colorado',
    location: 'Colorado',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Colorado',
    externalLinks: [
      { label: 'Colorado Higher Education Authority', url: 'https://highered.colorado.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Connecticut GPA Calculator',
    shortName: 'Connecticut',
    location: 'Connecticut',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Connecticut',
    externalLinks: [
      { label: 'Connecticut Higher Education Authority', url: 'https://www.ctohe.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Delaware GPA Calculator',
    shortName: 'Delaware',
    location: 'Delaware',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Delaware',
    externalLinks: [
      { label: 'Delaware Higher Education Authority', url: 'https://dhec.delaware.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Florida GPA Calculator',
    shortName: 'Florida',
    location: 'Florida',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Florida',
    externalLinks: [
      { label: 'Florida Higher Education Authority', url: 'https://www.flbog.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Georgia GPA Calculator',
    shortName: 'Georgia',
    location: 'Georgia',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Georgia',
    externalLinks: [
      { label: 'Georgia Higher Education Authority', url: 'https://www.usg.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Hawaii GPA Calculator',
    shortName: 'Hawaii',
    location: 'Hawaii',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Hawaii',
    externalLinks: [
      { label: 'Hawaii Higher Education Authority', url: 'https://www.hawaii.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Idaho GPA Calculator',
    shortName: 'Idaho',
    location: 'Idaho',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Idaho',
    externalLinks: [
      { label: 'Idaho Higher Education Authority', url: 'https://www.idahoboardofed.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Illinois GPA Calculator',
    shortName: 'Illinois',
    location: 'Illinois',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Illinois',
    externalLinks: [
      { label: 'Illinois Higher Education Authority', url: 'https://www.ibhe.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Indiana GPA Calculator',
    shortName: 'Indiana',
    location: 'Indiana',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Indiana',
    externalLinks: [
      { label: 'Indiana Higher Education Authority', url: 'https://www.in.gov/che/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Iowa GPA Calculator',
    shortName: 'Iowa',
    location: 'Iowa',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Iowa',
    externalLinks: [
      { label: 'Iowa Higher Education Authority', url: 'https://iowacollegeaid.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Kansas GPA Calculator',
    shortName: 'Kansas',
    location: 'Kansas',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Kansas',
    externalLinks: [
      { label: 'Kansas Higher Education Authority', url: 'https://www.kansasregents.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Kentucky GPA Calculator',
    shortName: 'Kentucky',
    location: 'Kentucky',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Kentucky',
    externalLinks: [
      { label: 'Kentucky Higher Education Authority', url: 'https://cpe.ky.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Louisiana GPA Calculator',
    shortName: 'Louisiana',
    location: 'Louisiana',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Louisiana',
    externalLinks: [
      { label: 'Louisiana Higher Education Authority', url: 'https://www.louisianahighered.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Maine GPA Calculator',
    shortName: 'Maine',
    location: 'Maine',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Maine',
    externalLinks: [
      { label: 'Maine Higher Education Authority', url: 'https://www.maine.gov/education/highered' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Maryland GPA Calculator',
    shortName: 'Maryland',
    location: 'Maryland',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Maryland',
    externalLinks: [
      { label: 'Maryland Higher Education Authority', url: 'https://www.mhec.maryland.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Massachusetts GPA Calculator',
    shortName: 'Massachusetts',
    location: 'Massachusetts',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Massachusetts',
    externalLinks: [
      { label: 'Massachusetts Higher Education Authority', url: 'https://www.mass.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Michigan GPA Calculator',
    shortName: 'Michigan',
    location: 'Michigan',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Michigan',
    externalLinks: [
      { label: 'Michigan Higher Education Authority', url: 'https://www.michigan.gov/mistudentaid' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Minnesota GPA Calculator',
    shortName: 'Minnesota',
    location: 'Minnesota',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Minnesota',
    externalLinks: [
      { label: 'Minnesota Higher Education Authority', url: 'https://www.mhec.state.mn.us/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Mississippi GPA Calculator',
    shortName: 'Mississippi',
    location: 'Mississippi',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Mississippi',
    externalLinks: [
      { label: 'Mississippi Higher Education Authority', url: 'https://www.mississippi.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Missouri GPA Calculator',
    shortName: 'Missouri',
    location: 'Missouri',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Missouri',
    externalLinks: [
      { label: 'Missouri Higher Education Authority', url: 'https://dhewd.mo.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Montana GPA Calculator',
    shortName: 'Montana',
    location: 'Montana',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Montana',
    externalLinks: [
      { label: 'Montana Higher Education Authority', url: 'https://mus.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Nebraska GPA Calculator',
    shortName: 'Nebraska',
    location: 'Nebraska',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Nebraska',
    externalLinks: [
      { label: 'Nebraska Higher Education Authority', url: 'https://www.ccpe.nebraska.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Nevada GPA Calculator',
    shortName: 'Nevada',
    location: 'Nevada',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Nevada',
    externalLinks: [
      { label: 'Nevada Higher Education Authority', url: 'https://www.nevada.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'New Hampshire GPA Calculator',
    shortName: 'New Hampshire',
    location: 'New Hampshire',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in New Hampshire',
    externalLinks: [
      { label: 'New Hampshire Higher Education Authority', url: 'https://www.nh.gov/nhes/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'New Jersey GPA Calculator',
    shortName: 'New Jersey',
    location: 'New Jersey',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in New Jersey',
    externalLinks: [
      { label: 'New Jersey Higher Education Authority', url: 'https://www.nj.gov/highereducation/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'New Mexico GPA Calculator',
    shortName: 'New Mexico',
    location: 'New Mexico',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in New Mexico',
    externalLinks: [
      { label: 'New Mexico Higher Education Authority', url: 'https://hed.state.nm.us/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'New York GPA Calculator',
    shortName: 'New York',
    location: 'New York',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in New York',
    externalLinks: [
      { label: 'New York Higher Education Authority', url: 'https://www.nysed.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'North Carolina GPA Calculator',
    shortName: 'North Carolina',
    location: 'North Carolina',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in North Carolina',
    externalLinks: [
      { label: 'North Carolina Higher Education Authority', url: 'https://www.northcarolina.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'North Dakota GPA Calculator',
    shortName: 'North Dakota',
    location: 'North Dakota',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in North Dakota',
    externalLinks: [
      { label: 'North Dakota Higher Education Authority', url: 'https://www.ndus.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Ohio GPA Calculator',
    shortName: 'Ohio',
    location: 'Ohio',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Ohio',
    externalLinks: [
      { label: 'Ohio Higher Education Authority', url: 'https://www.ohiohighered.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Oklahoma GPA Calculator',
    shortName: 'Oklahoma',
    location: 'Oklahoma',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Oklahoma',
    externalLinks: [
      { label: 'Oklahoma Higher Education Authority', url: 'https://www.okhighered.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Oregon GPA Calculator',
    shortName: 'Oregon',
    location: 'Oregon',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Oregon',
    externalLinks: [
      { label: 'Oregon Higher Education Authority', url: 'https://www.oregon.gov/highered/Pages/index.aspx' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Pennsylvania GPA Calculator',
    shortName: 'Pennsylvania',
    location: 'Pennsylvania',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Pennsylvania',
    externalLinks: [
      { label: 'Pennsylvania Higher Education Authority', url: 'https://www.pacollegetransfer.com/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Rhode Island GPA Calculator',
    shortName: 'Rhode Island',
    location: 'Rhode Island',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Rhode Island',
    externalLinks: [
      { label: 'Rhode Island Higher Education Authority', url: 'https://www.uri.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'South Carolina GPA Calculator',
    shortName: 'South Carolina',
    location: 'South Carolina',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in South Carolina',
    externalLinks: [
      { label: 'South Carolina Higher Education Authority', url: 'https://www.che.sc.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'South Dakota GPA Calculator',
    shortName: 'South Dakota',
    location: 'South Dakota',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in South Dakota',
    externalLinks: [
      { label: 'South Dakota Higher Education Authority', url: 'https://www.sdbor.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Tennessee GPA Calculator',
    shortName: 'Tennessee',
    location: 'Tennessee',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Tennessee',
    externalLinks: [
      { label: 'Tennessee Higher Education Authority', url: 'https://www.tn.gov/thec.html' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Texas College GPA Calculator',
    shortName: 'Texas College',
    location: 'Texas',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Texas',
    externalLinks: [
      { label: 'Texas Higher Education Authority', url: 'https://www.highered.texas.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Utah GPA Calculator',
    shortName: 'Utah',
    location: 'Utah',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Utah',
    externalLinks: [
      { label: 'Utah Higher Education Authority', url: 'https://www.higheredutah.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Vermont GPA Calculator',
    shortName: 'Vermont',
    location: 'Vermont',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Vermont',
    externalLinks: [
      { label: 'Vermont Higher Education Authority', url: 'https://www.vtaffairs.org/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Virginia GPA Calculator',
    shortName: 'Virginia',
    location: 'Virginia',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Virginia',
    externalLinks: [
      { label: 'Virginia Higher Education Authority', url: 'https://www.schev.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Washington GPA Calculator',
    shortName: 'Washington',
    location: 'Washington',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Washington',
    externalLinks: [
      { label: 'Washington Higher Education Authority', url: 'https://www.wsac.wa.gov/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'West Virginia GPA Calculator',
    shortName: 'West Virginia',
    location: 'West Virginia',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in West Virginia',
    externalLinks: [
      { label: 'West Virginia Higher Education Authority', url: 'https://www.wvhepc.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Wisconsin GPA Calculator',
    shortName: 'Wisconsin',
    location: 'Wisconsin',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Wisconsin',
    externalLinks: [
      { label: 'Wisconsin Higher Education Authority', url: 'https://www.wisconsin.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
  {
    ...
    schoolName: 'Wyoming GPA Calculator',
    shortName: 'Wyoming',
    location: 'Wyoming',
    strengths: 'strong regional academic support, state university systems, and transfer-friendly GPA policies in Wyoming',
    externalLinks: [
      { label: 'Wyoming Higher Education Authority', url: 'https://www.wiche.edu/' },
      { label: 'National Center for Education Statistics', url: 'https://nces.ed.gov/' },
      { label: 'College Board', url: 'https://www.collegeboard.org/' },
    ],
  },
...
function createSchoolGpaPageContent(school: SchoolTemplate): SchoolGpaPageContent {
  ...
  return {
    toc: [
      ...
      { id: 'gpa-formula', label: 'GPA Formula Explained' },
      { id: 'example-calculation', label: 'Example Calculation' },
      { id: 'state-planning', label: `${school.location} GPA Planning` },
    ...
    sections: [
      ...
      {
        id: 'state-planning',
        title: `${school.location} GPA Planning`,
        content: `<p>GPA goals in ${school.location} are shaped by local admissions policies, transfer pathways, and scholarship requirements. Use this calculator to compare the grade targets needed for public universities, community colleges, and honors programs in your state.</p>
        <p>Many students in ${school.location} focus on balancing strong performance in major coursework with the credit hours that matter most for state-level academic and financial aid benchmarks. This tool makes it easy to compare a high grade in a heavy course versus steady results across a broader schedule.</p>
        <p>For official state guidance, consult ${primaryLink.label} and your ${school.location} education authority. Together with this calculator, these sources help you set a realistic academic plan that fits local admissions expectations.</p>`,
      },
      {
        id: 'expectations',
        ...
        <p>Your target GPA should be aligned with your major, scholarship goals, and future plans. For example, ${school.shortName} students in business, engineering, or health sciences may need higher averages for admission to specialized programs or internships in ${school.location}.</p>
        ...
        <p>For official information, consult <a href="${primaryLink.url}" target="_blank" rel="noreferrer" class="text-blue-600 hover:underline">${primaryLink.label}</a> and your ${school.location} higher education authority for state-specific admissions guidance.</p>`,
      },
      {
        id: 'improve-gpa',
        title: 'How to Improve Your GPA',
    ...
    faqs: [
      ...
      {
        question: `What GPA is competitive for students in ${school.location}?`,
        answer: `A competitive GPA for students in ${school.location} depends on the program, but many aim for a cumulative average of 3.5 or higher. Local transfer, scholarship, and admissions standards often reward consistent performance across core coursework and high-credit classes.`,
      },
      {
